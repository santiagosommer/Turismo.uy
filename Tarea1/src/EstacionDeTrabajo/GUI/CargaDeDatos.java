	...
	public Boolean cargarDatos() throws UsuarioRepetidoException {
		if (yaCargo)
			...
			try {
				...
				interfazUsuario.crearInscripcion("Rosa Maria", "Degusta Agosto" , 3 , (float) 2400 , LocalDate.of(2022, 8, 15));
				interfazUsuario.crearInscripcion("Elvis", "Degusta Agosto" , 5 , (float) 4000 , LocalDate.of(2022, 8, 16));
				interfazUsuario.crearInscripcion("Rosa Maria", "Tour Colonia del Sacramento 18-09", 3 , (float) 1200,  LocalDate.of(2022, 8, 18));
				interfazUsuario.crearInscripcion("Elizabeth", "Tour Colonia del Sacramento 18-09", 1, (float) 400, LocalDate.of(2022, 8, 19));
				interfazUsuario.crearInscripcion("Johann Sebastian", "Almuerzo 2", 2, (float) 1600 , LocalDate.of(2022, 8, 19));
				interfazUsuario.crearInscripcion("Alvaro","Teatro con Sabores 1", 1, (float) 500 , LocalDate.of(2022, 8, 19));
				interfazUsuario.crearInscripcion("Alvaro", "Teatro con Sabores 2", 10, (float) 5000 , LocalDate.of(2022, 8, 20));
				interfazUsuario.crearInscripcion("Bob","Teatro con Sabores 2", 2, (float) 1000 , LocalDate.of(2022, 8, 20));
				interfazUsuario.crearInscripcion("Anibla","Teatro con Sabores 2", 1, (float) 500 , LocalDate.of(2022, 8, 21));
				interfazUsuario.crearInscripcion("Antonio", "Degusta Setiembre" , 11, (float) 8800 , LocalDate.of(2022, 8, 21));
