                        ...
                        <% for (int i=0; i< Salidas.size();i++) { %>
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-6">
                                <div class="card shadow">
                                    <div class="card-body">                                        
                                        <p class="card-text">
                                        <%=  Salidas.get(i).getNombre() %>
                  <p><a href="/TurismoMobile/ConsultaSalida?paramS=<%=Salidas.get(i).getNombre()%>" class="links">Leer mas.</a></p> 
                                        </p>                                                                                
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="salidas">
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-6">
                                    <div class="card shadow">
                                        <div class="card-body">                                        
                                            <p class="card-text">
                                            <%=  paque.get(i).getNombre() %>
                  <p><a href="/TurismoMobile/ConsultaPaquete?paramPaq=<%=paque.get(i).getNombre()%>" class="links">Leer mas.</a></p>  
                                            </p>                                                                                
                                        </div>
                                    </div>
                                </div>                               
