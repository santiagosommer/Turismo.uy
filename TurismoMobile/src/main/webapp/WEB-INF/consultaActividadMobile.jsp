        ...
        <div class="col-sm-8 col-md-10 col-lg-6 col-xl-4">
            <div class="card shadow">
                <div class="card-body">
                  ...
                  <p><a href="/movil/ConsultaSalida?paramS=<%=Salidas.get(i).getNombre()%>" class="links">Leer mas.</a></p> 
                                        </p>                                                                                
                                    </div>
                                </div>
                            </div>
                  ...
                  <p><a href="/movil/ConsultaPaquete?paramPaq=<%=paque.get(i).getNombre()%>" class="links">Leer mas.</a></p>  
                                            </p>                                                                                
                                        </div>
                                    </div>
                                </div>                               
