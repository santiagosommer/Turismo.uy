    ...
    <div class="content">
        <section class="form-register">
            ...
            <div class="input-outer">
                ...
                <input type="password" class="input-style" placeholder="Contrase�a" name="password" required>
            </div>
            <div class="input-outer">
                <img src="./../icons/lock.svg" class="icon">
                <input type="password" class="input-style" placeholder="Confirmar contrase�a" name="confirmPasword" required>
            </div>
            <div class="input-outer">
                <img src="./../icons/write.svg" class="icon">
                <input type="text" class="input-style" placeholder="Descripci�n" name="descripcion" required>
            </div>
            <div class="input-outer">
                <img src="./../icons/url.svg" class="icon">
                <input type="text" class="input-style" placeholder="Url (opcional)" name="url" required>
            </div>
